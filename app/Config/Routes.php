...
$routes->get('/stock/read', 'stock::read');
$routes->post('/stock/create', 'stock::create');
$routes->post('/stock/edit', 'stock::edit');
$routes->post('/stock/update', 'stock::update');
$routes->post('/stock/delete', 'stock::delete');
$routes->post('/stock/delete_batch', 'stock::delete_batch');
