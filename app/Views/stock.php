        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <table id="table" data-toolbar="#toolbar" data-search="true" data-show-refresh="true"
                    data-show-columns="false" data-minimum-count-columns="2" data-show-pagination-switch="false"
                    data-detail-view="false" data-detail-formatter="detailFormatter" data-pagination="true"
                    data-page-list="[10, 25, 50, 100, all]" data-click-to-select="false" data-id-field="id"
                    data-height="auto" data-url="<?= base_url('product/read') ?>" data-side-pagination="server"
                    data-response-handler="responseHandler" data-sort-name="id" data-sort-order="desc"></table>
            </div>
        </div>
    </div>
</main>
...
<script>
            ...
            let dialog = bootbox.confirm({
                ...
                callback: function (result) {
                    ...
                    if (result) {
                        ...
                        $(".bootbox-accept").html($(".bootbox-accept").html() + xsetting
                            .spinner);
                        ...
                        $.post(base_url + `/product/delete`, {
                            ...
                            .done(function (data) {
                                ...
                                // animation
                                $(".bootbox-accept, .bootbox-cancel").prop("disabled",
                                    false);
                                ...
                                if (data.status) {
                                    ...
                                    dialog.modal(
                                        'hide'
                                    ); // hide modal after get success response
                                }
                            })
                            .fail(function (xhr, statusText, errorThrown) {
                                alert(xhr.responseText);
    ...
    $delete.on('click', function () {
        ...
        bootbox.confirm({
            ...
            callback: function (result) {
                if (result) {
                    $.post(base_url + `/product/delete_batch`, {
                        ids: ids
                    }, function (data) { }, 'json')
                        .done(function (data) {
                            if (data.status) {
